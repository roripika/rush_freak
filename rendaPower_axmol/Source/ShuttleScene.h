...
{
protected:
    ax::Sprite * m_PlanetSprite;
    ShuttleModel * m_RocketSprite;
    ax::Sprite * m_CloudSprite1;
    ax::Sprite * m_CloudSprite2;
    ax::LayerGradient * m_BackGroundLayer;
    
    ax::Menu * m_menu;
    
    ax::Label * m_HiScoreLabel;
    ax::Label * m_ScoreLabel;
    ax::Label * m_ReadyLabel;
    ax::Label * m_SpeedLabel;
    ax::Label * m_PowerLabel;
